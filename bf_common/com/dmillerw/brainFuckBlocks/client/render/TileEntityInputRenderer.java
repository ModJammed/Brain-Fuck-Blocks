...
public class TileEntityInputRenderer extends TileEntitySpecialRenderer {

	public void renderMonitorAt(TileEntityInput tile, double x, double y, double z, float f) {
	...
	public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8) {
		renderMonitorAt((TileEntityInput) var1, var2, var4, var6, var8);
	}
