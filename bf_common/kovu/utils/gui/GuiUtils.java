...
public class GuiUtils {
	...
	public static void drawRect(int x, int y, int x1, int y1, double r, double g, double b, double a)
	{
		renderRect(x, y, x1, y1, r, g, b, a);
	}
	
	public static void drawBorderedRect(int x, int y, int x1, int y1, double r, double g, double b, double a, float lineWidth, double r1, double g1, double b1, double a1)
	{
		renderRect(x, y, x1, y1, r, g, b, a);
		setupRendering();
		disableDefaults();
		GL11.glLineWidth(lineWidth);
		GL11.glColor4d(r1/255, g1/255, b1/255, a1/255);
	...
	public static void renderRect(int x, int y, int x1, int y1, double r, double g, double b, double a)
	{
		setupRendering();
		disableDefaults();
